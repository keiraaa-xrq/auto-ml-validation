...
def project_field():
    form_fields = [dbc.Row([
        ...
        html.Div(id="failed-modeling-message",
                 style={"color": "red", 'textAlign': 'center'})
    ]
...
def rep_dataset_layout() -> html.Div:
    ...
    return html.Div([
        # New Heading
        html.Div([
            html.H5('Part I. Model Replication', style={
                    'textAlign': 'left', 'fontWeight': 'bold'})
        ], style={'backgroundColor': '#ffaf77', 'width': '100%', 'top': 0, 'left': 0, 'margin': 0}),
        dbc.Row([
            dbc.Col(
                dbc.Form([
                    html.H5("Select Model's Algorithm: ",
        ...
        html.Div([
            # Instructions
            html.H5("Please upload the JSON file of model's hyperparameters: ", style={
                    'textAlign': 'center'}),
            html.H6("Within the file, keys will be the parameters name E.g. {class_weight: {0:0.8, 1:0.2}}", style={
                    'textAlign': 'center', 'color': '#4f4f4f ', 'font-size': '13px'}),
            # Files Upload
            html.H6('Hyperparameters Values', style={'textAlign': 'center'}),
            html.Div([
                dcc.Input(id='hyperparams-input',
                          placeholder='Select JSON File...', type='text', value=''),
                dcc.Upload(
        ...
        html.Div([
            # Instructions
            html.H5('Please upload the processed datasets for running the model:', style={
                    'textAlign': 'center'}),
            ...
            html.Div([
                dcc.Input(id='train-dataset-input',
                          placeholder='Select Train Dataset...', type='text', value=''),
                dcc.Upload(
        ...
        html.Div([
            ...
            html.Div([
                dcc.Input(id='test-dataset-input',
                          placeholder='Select Test Dataset...', type='text', value=''),
                dcc.Upload(
        ...
        html.Div([
            ...
            html.Div([
                dcc.Input(id='other-dataset-input',
                          placeholder='Select Other Dataset...', type='text', value=''),
                dcc.Upload(
...
def auto_dataset_layout() -> html.Div:
    ...
    return html.Div([
        html.Div([
            html.H5('Part II. Automatic Benchmark', style={
                    'textAlign': 'left', 'fontWeight': 'bold'})
        ], style={'backgroundColor': '#ffaf77', 'width': '100%', 'top': 0, 'left': 0, 'margin': 0}),
        html.Div([
            # Instructions
            # Dropdown
            html.H6('Please select evaluation metric:',
                    style={'textAlign': 'center'}),
            dcc.Dropdown(
            ...
            html.H6('Incorporate Auto-Feature Selection?',
