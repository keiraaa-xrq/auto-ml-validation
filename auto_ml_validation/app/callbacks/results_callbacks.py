...
def output_psi_ks_table(num_of_bins, trigger, file_name):
    if trigger:
        ...
        html.H6('KS Test Test: ' + str(ks_dict_re['Test']), style={'textAlign': 'left', 'fontWeight': 'bold'}),
...
@app.callback(
    Output("gini-feature-multi-dynamic-dropdown", "options"), Output("gini-feature-multi-dynamic-dropdown-re", "options"),
    Input('validator-input-trigger', 'data'),
    Input('validator-input-file','data')
)            
...
@app.callback(
    Output("csi-feature-multi-dynamic-dropdown", "options"), Output("csi-feature-multi-dynamic-dropdown-re", "options"),
    Input('validator-input-trigger', 'data'),
    Input('validator-input-file','data')
)            
...
def output_transparency_plots(trigger, file_name):
    if trigger:
        ...
        evaluator = transparency_metrics_evaluator.TransparencyMetricsEvaluator(auto_model, bm_train_data['processed_X'])

        local_lime_fig, global_lime_fig, local_text_lime, global_text_lime = evaluator.lime_interpretability()
        global_lime_fig.savefig('././auto_ml_validation/app/assets/images/global_lime_bm.png', bbox_inches='tight')
        local_lime_fig.savefig('././auto_ml_validation/app/assets/images/local_lime_bm.png', bbox_inches='tight')

        local_shap_fig, global_shap_fig, local_text_shap, global_text_shap = evaluator.shap_interpretability()
        local_shap_fig.savefig('././auto_ml_validation/app/assets/images/local_shap_bm.png',  bbox_inches='tight')
        global_shap_fig.savefig('././auto_ml_validation/app/assets/images/global_shap_bm.png', bbox_inches='tight')
        ...
        try:
            evaluator = transparency_metrics_evaluator.TransparencyMetricsEvaluator(re_model, re_train_data['processed_X'])

            local_lime_fig, global_lime_fig, local_text_lime, global_text_lime = evaluator.lime_interpretability()
            global_lime_fig.savefig('././auto_ml_validation/app/assets/images/global_lime_re.png', bbox_inches='tight')
            local_lime_fig.savefig('././auto_ml_validation/app/assets/images/local_lime_re.png', bbox_inches='tight')
            local_shap_fig, global_shap_fig, local_text_shap, global_text_shap = evaluator.shap_interpretability()
            local_shap_fig.savefig('././auto_ml_validation/app/assets/images/local_shap_re.png',  bbox_inches='tight')
            global_shap_fig.savefig('././auto_ml_validation/app/assets/images/global_shap_re.png', bbox_inches='tight')
